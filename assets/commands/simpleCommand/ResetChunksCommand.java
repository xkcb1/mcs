                ...
                for (int s = chunkPos.x - radius; s <= chunkPos.x + radius; ++s) {
                    ...
                    for (int u = chunkPos3.z - t; u <= chunkPos3.z + t; ++u) {
                        for (int v = chunkPos3.x - t; v <= chunkPos3.x + t; ++v) {
                            ...
                            Chunk chunk2 = chunk instanceof WrapperProtoChunk ? new WrapperProtoChunk(((WrapperProtoChunk)chunk).getWrappedChunk(), true) : (chunk instanceof WorldChunk ? new WrapperProtoChunk((WorldChunk)chunk, true) : chunk);
                            list.add(chunk2);
                        }
                    }
