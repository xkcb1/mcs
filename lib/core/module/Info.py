...
def init(parent,Name,self):
    ...
    KeyPanel_0.setStyleSheet('''#KeyPanel_0{border:1px solid #ddd !important;}
                             #KeyPanel_0:hover {background-color:#f3f3f3;}''')
    KeyPanel_0.setMaximumHeight(30)
    labelA_0 = QLabel()
    labelA_0.setText(f'<a style="border: 0px;color:#777;font-size:13px;text-align: right;">Last Updata time :</a>')
    #
    ...
    LabelB_0.setStyleSheet('background-color:rgba(0,0,0,0);border: 0px;color:#444;border-radius:5px;text-align: center;padding-left:3px;')
    
    #
    labelC_0 = QLabel()
    labelC_0.setText('<a style="color:#777;font-size:14px;">Version :</a>')
    ...
    LabelD_0.setStyleSheet('background-color:rgba(0,0,0,0);border: 0px;color:#444;border-radius:5px;text-align: center;padding-left:3px;')
    #
    ...
    labelA_1 = QLabel()
    labelA_1.setText('<a style="color:#777;font-size:13px;text-align: right;">打开文件</a>')
    labelA_1.setMaximumWidth(70)
    labelA_1.setMinimumWidth(70)
    #
    LabelB_1 = QLabel()
    LabelB_1.setText(' <b style="font-size:14px;">ctrl</b>')
    LabelB_1.setStyleSheet('background-color:#ebebeb;color:#444;border-radius:5px;text-align: center;padding-left:3px;')
    LabelB_1.setMaximumWidth(35)
    LabelB_1.setMinimumSize(35,22)
    LabelB_1.setMaximumHeight(22)
    #
    labelC_1 = QLabel()
    labelC_1.setText('<a style="color:#777;font-size:14px;">+</a>')
    #
    LabelD_1 = QLabel()
    LabelD_1.setText(' <b style="font-size:14px;">o</b>')
    LabelD_1.setStyleSheet('background-color:#ebebeb;color:#444;border-radius:5px;text-align: center;padding-left:3px;')
    ...
    labelA_2 = QLabel()
    labelA_2.setText('<a style="color:#777;font-size:13px;text-align: right;">打开文件夹</a>')
    labelA_2.setMaximumWidth(70)
    labelA_2.setMinimumWidth(70)
    #
    LabelB_2 = QLabel()
    LabelB_2.setText(' <b style="font-size:14px;">ctrl</b>')
    LabelB_2.setStyleSheet('background-color:#ebebeb;color:#444;border-radius:5px;text-align: center;padding-left:3px;')
    LabelB_2.setMaximumWidth(35)
    LabelB_2.setMinimumSize(35,22)
    LabelB_2.setMaximumHeight(22)
    #
    labelC_2 = QLabel()
    labelC_2.setText('<a style="color:#777;font-size:14px;">+</a>')
    #
    LabelD_2 = QLabel()
    LabelD_2.setText(' <b style="font-size:14px;">d</b>')
    LabelD_2.setStyleSheet('background-color:#ebebeb;color:#444;border-radius:5px;text-align: center;padding-left:3px;')
    ...
    labelA_3 = QLabel()
    labelA_3.setText('<a style="color:#777;font-size:13px;">新建文件</a>')
    labelA_3.setMaximumWidth(70)
    labelA_3.setMinimumWidth(70)
    #
    LabelB_3 = QLabel()
    LabelB_3.setText(' <b style="font-size:14px;">ctrl</b>')
    LabelB_3.setStyleSheet('background-color:#ebebeb;color:#444;border-radius:5px;text-align: center;padding-left:3px;')
    LabelB_3.setMaximumWidth(35)
    LabelB_3.setMinimumSize(35,22)
    LabelB_3.setMaximumHeight(22)
    #
    labelC_3 = QLabel()
    labelC_3.setText('<a style="color:#777;font-size:14px;">+</a>')
    #
    LabelD_3 = QLabel()
    LabelD_3.setText(' <b style="font-size:14px;">n</b>')
    LabelD_3.setStyleSheet('background-color:#ebebeb;color:#444;border-radius:5px;text-align: center;padding-left:3px;')
