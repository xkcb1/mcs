...
class SettingWindow(QMainWindow):
    def __init__(self,parent,User):
        ...
        scroll.setStyleSheet(
            '''#scroll{background-color:#f9f9f9;border:0px !important;border-bottom-left-radius: 7px;
        ...
        self.widget_2.setLayout(self.MainLayout)
        ...
        #
        self.ThisButton = [FristAll,window,editor,workspace,manager,extend]
        ...
        self.WindowName.setText('Setting - '+self.User+' - 首选项')
...
'主题版本':'0.0.1',
'启用主题':True}
        themePanel = AttributePanel('设置主题样式',theme,[self.changeTheme,print,print,print],True)
