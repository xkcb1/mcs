...
StarterInfo = {
    ...
    "Model":{
        "B":{"size":10,"Window":None,"Children":{
            "LeftTopDiv":{"size":10,"Window":"Resource","Children":None,"float":"top"},
            "LeftBottomDiv":{"size":10,"Window":"ItemList","Children":None,"float":"bottom"},
            },"float":"left"},
    ...
    "Terminal":{
        ...
        "PROJECT_LIST":['None']},
    'Start':{
        "A":{"size":19,"Window":'Asset',"Children":None,"float":"left"},
        "B":{"size":51,"Window":'Info',"Children":None,"float":"right"},
        "PROJECT_LIST":['None'],
    },
    'Nbt':{
        ...
        "B":{"size":20,"Window":'HexEditor',"Children":None,"float":"right"},
        "PROJECT_LIST":['None'],
    },
}